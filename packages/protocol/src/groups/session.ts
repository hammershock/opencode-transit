    ...
    .add(
      HttpApiEndpoint.post("session.create", "/api/session", {
        payload: Schema.Struct({
          ...
          approvalMode: Session.Info.fields.approvalMode.pipe(Schema.optional),
        }),
    ...
    .add(
      HttpApiEndpoint.get("session.modelContext", "/api/session/:sessionID/model-context", {
        ...
        success: Schema.Struct({
          ...
          systemParts: Schema.NullOr(Schema.Array(ModelContext.SystemPart)),
          ...
          tools: Schema.Array(ModelContext.Tool),
