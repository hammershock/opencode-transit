...
export function render(
  ...
  return [
    ...
    "Use a clear, stable alias such as /root/review when spawning an Agent. Visible contacts: " +
      ...
      ".",
    "For agent_spawn, set subagent_type to an exact ID shown in the available subagent catalog. For general work use general only if that ID is listed. Do not guess or rewrite IDs such as general-purpose; an unavailable type does not start an Agent.",
