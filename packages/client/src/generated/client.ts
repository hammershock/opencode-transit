import type {
  ...
  SessionsInstructionsStatusInput,
  SessionsInstructionsStatusOutput,
  ...
  TargetsUnbindPortableInput,
  TargetsUnbindPortableOutput,
...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    sessions: {
      ...
      instructionsStatus: (input: SessionsInstructionsStatusInput, requestOptions?: RequestOptions) =>
        request<SessionsInstructionsStatusOutput>(
          {
            method: "GET",
            path: `/api/session/${encodeURIComponent(input.sessionID)}/instructions/status`,
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
          },
    ...
    targets: {
      ...
      unbindPortable: (input: TargetsUnbindPortableInput, requestOptions?: RequestOptions) =>
        request<TargetsUnbindPortableOutput>(
          {
            method: "DELETE",
            path: `/api/target-binding/${encodeURIComponent(input.portableTargetLabel)}`,
            body: { expectedRevision: input["expectedRevision"], expectedSessionIDs: input["expectedSessionIDs"] },
            successStatus: 200,
            declaredStatuses: [409, 403, 400, 404, 500, 401],
            empty: false,
          },
