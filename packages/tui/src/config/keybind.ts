...
export const Definitions = {
  ...
  session_location_rebind: keybind("ctrl+shift+r", "Force rebind session location"),
  ...
  model_usage_view: keybind("ctrl+u", "View provider usage"),
  model_usage_configure: keybind("ctrl+shift+u", "Configure provider usage footer"),
  model_usage_refresh: keybind("ctrl+r", "Refresh provider usage"),
  usage_move_up: keybind("shift+up", "Move usage meter up"),
  usage_move_down: keybind("shift+down", "Move usage meter down"),
  ...
  "dialog.harness.unset": keybind("backspace", "Unset instruction path"),
  "dialog.harness.preview": keybind("ctrl+p", "Preview instruction file"),
  "dialog.harness.line_up": keybind("up", "Scroll instruction preview up one line"),
  "dialog.harness.line_down": keybind("down", "Scroll instruction preview down one line"),
  "dialog.harness.page_up": keybind("pageup", "Scroll instruction preview up one page"),
  "dialog.harness.page_down": keybind("pagedown", "Scroll instruction preview down one page"),
  ...
  "dialog.model_context.page_down": keybind("pagedown", "Scroll model context down one page"),
  "dialog.model_context.home": keybind("home", "Jump to the start of model context"),
  "dialog.model_context.end": keybind("end", "Jump to the end of model context"),
  "dialog.model_context.copy": keybind("c", "Copy model context source"),
  "dialog.skill.preview": keybind("ctrl+o", "Preview selected Skill"),
  "dialog.skill.line_up": keybind("up", "Scroll Skill content up one line"),
  "dialog.skill.line_down": keybind("down", "Scroll Skill content down one line"),
  "dialog.skill.page_up": keybind("pageup", "Scroll Skill content up one page"),
  "dialog.skill.page_down": keybind("pagedown", "Scroll Skill content down one page"),
  "dialog.skill.home": keybind("home", "Jump to the start of Skill content"),
  "dialog.skill.end": keybind("end", "Jump to the end of Skill content"),
  "dialog.skill.copy": keybind("c", "Copy Skill content"),
  "dialog.subagent.add": keybind("a", "Add subagent"),
  "dialog.subagent.delete": keybind("d", "Delete subagent"),
  "dialog.subagent.save": keybind("ctrl+s", "Save subagent"),
  ...
  "dialog.target.add": keybind("ctrl+a", "Add target"),
  "dialog.target.delete": keybind("ctrl+d", "Delete target"),
  "dialog.target.refresh": keybind("ctrl+r", "Refresh target status"),
...
export const CommandMap = {
  ...
  session_location_rebind: "session.location.rebind",
  ...
  model_usage_view: "model.dialog.usage.view",
  model_usage_configure: "model.dialog.usage.configure",
  model_usage_refresh: "model.dialog.usage.refresh",
  usage_move_up: "usage.move.up",
  usage_move_down: "usage.move.down",
